...
$objfun=(0.84-0.2*&min(100,$min)/3625.5)/($mass/$ESTIMATE);
print OUTPUT "MASS OBJFUN VALUE: $mass\n";
print OUTPUT "MASS OBJFUN VALUE DISCOUNTING THE INTERMEDIATE PHASE: ".($mass/$ESTIMATE)."\n";
