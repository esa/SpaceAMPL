...
@guesses=("guesslambert2.inc","guesstangential3.inc","guesstangential3m.inc");#,"guesstangential.inc","guesstangential2.inc","guesstangential2m.inc",,"crazyguess.inc","guesslambert.inc",);
$mass=1;
$min=3652.5;
$total=0;
$infis=1;
...
#IN CASE YOU WOULD LIKE TO IGNORE A POSSIBLE INFEASIBILITY CHANGE THE VALUE $infis TO 0 IN THIS BLOCK	
	if (&infeasible) {
	...
	foreach (<MAINOLD>){
	    if (/param depart/) { 
	     ...
	     $_="param M	     :=   (".($mass*2000).");	\n";
	      ...
	      $_="var tT	     :=   ".($data[$j*2+1]+100).";		#Arrival time (MJD2000)\n";
	    }
	    if ((/include/) & (/guess/)) {
	      $_="include include/".$guesses[$k].";\n";
	    }
